...
namespace OpenAI
{
    public class ChatGPTChmonya : MonoBehaviour
    {
       ...
       // private string Instruction = "Act as a random stranger in a chat room and reply to the questions.\nQ: ";
        ...
        private string Instruction = "Act as a random stranger in a chat room and reply to the questions in a cynic matter.\nQ: ";
